 ...
 *  Copyright (C) 2014--2016  Han Chen, Matthew P. Conomos
 *
  ...
  SEXP fitglmm_nm(SEXP Y_in, SEXP X_in, SEXP q_in, SEXP Phi_in, SEXP W_in, SEXP method_in, SEXP dispersion_in, SEXP tau_in, SEXP fixtau_in, SEXP maxiter_in, SEXP tol_in)
{
  ...
  SEXP fitglmm_ai(SEXP Y_in, SEXP X_in, SEXP q_in, SEXP Phi_in, SEXP W_in, SEXP tau_in, SEXP fixtau_in, SEXP tol_in)
{
	try {
		vec Y = as<vec>(Y_in);
		mat X = as<mat>(X_in);
